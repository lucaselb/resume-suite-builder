...
export const sampleResumeData: ResumeData = {
  ...
  experience: [
    ...
    },
    {
      ...
      current: false,
      description:
        "• Developed customer-facing web applications with React and TypeScript\n• Collaborated with UX/UI designers to implement pixel-perfect designs\n• Optimized application performance resulting in 40% faster load times\n• Integrated third-party APIs and payment gateways",
    },
    {
      id: "3",
  ...
  projects: [
    {
      ...
      description:
        "Built a comprehensive analytics dashboard for e-commerce businesses featuring real-time sales tracking, customer insights, and inventory management. Implemented data visualization with Chart.js and integrated multiple payment gateways.",
      technologies: [
        "React",
        "Node.js",
        "PostgreSQL",
    ...
    },
    {
      ...
      description:
        "Developed a collaborative task management application with real-time updates, team collaboration features, and advanced filtering options. Implemented drag-and-drop functionality and offline capabilities.",
    ...
    },
    {
      ...
      description:
        "Created a RESTful API service that aggregates weather data from multiple sources and provides accurate forecasts with machine learning predictions. Includes rate limiting, caching, and comprehensive documentation.",
  ...
  selectedLayout: 1, // Default layout type
};
